...
| 🏎️ QQ 飞车 | 竞速漂移 racing | `qq-speed/` | 16 个 JS 模块 + HTML | ~740 KB | [claude-opus-5-5-qqfeiche3d.pages.dev](https://claude-opus-5-5-qqfeiche3d.pages.dev/) |
...
- **金币与车库** — 每场按名次 / 冠军 / 技巧（完美小喷、双喷、接氮气）发金币，圈数越多、对手越强奖励越高；车库里可购买 6 辆新车（跑车 / GT 宽体 / 超跑三种车身，极速、加速、操控、漂移、氮气属性各不相同），并升级引擎、涡轮、轮胎、氮气罐四项装备（各 5 级，全车通用）。存档在浏览器本地
...
│   └── package.json
├── qq-speed/              # QQ 飞车
│   ├── src/               # 16 个模块：vehicle / track / layouts / ai / maps / items / garage ...
│   ├── build.mjs
